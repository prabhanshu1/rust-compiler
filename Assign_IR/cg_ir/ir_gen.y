...
| round_exp '-' round_exp      {
  ...
  q.next.code="-, $$.map["value"],$1.map["value"], $3.map["value"]"; }
...
| round_exp '>' round_exp       {
  $$.map= make_entry("temp"+strconv.Itoa(temp_num));temp_num+=1;$$.map["type"]=$1.map["type"]; $$.map["true"]="label"+strconv.Itoa(label_num);$$.map["after"]="label"+strconv.Itoa(label_num);
    $$.code=new (node);p=copy_nodes($1.code,$$.code); p.next=new(node);q=copy_nodes(p.next,$3.code);q.next=new(node);if($1.map==NULL)||($3.map==NULL) {log.Fatal("variable not declared")};
  if($3.map["type"]!=$1.map["type"]) {log.Fatal("Type Mismatch")};
  q.next.code="ifgoto, jg, $1.map["value"], $3.map["value"], $$.map["true"]";r=new(node);q.next.next=r;r.code="=, $$.map["value"], 0";r.next=new(node);r.next.code="jmp, $$.map["after"]";r.next.next=new(node);s=r.next.next;s.code="label, $$.map["true"]";s.next=new(node);s.next.code="=, $$.map["value"], 1";s.next.next=new(node);s.next.next.code="label, $$.map["after"]"; }

| round_exp '<' round_exp   {
  $$.map= make_entry("temp"+strconv.Itoa(temp_num));temp_num+=1;$$.map["type"]=$1.map["type"];$$.map["true"]="label"+strconv.Itoa(label_num);$$.map["after"]="label"+strconv.Itoa(label_num);
    $$.code=new (node);p=copy_nodes($1.code,$$.code); p.next=new(node);q=copy_nodes(p.next,$3.code);q.next=new(node);if($1.map==NULL)||($3.map==NULL) {log.Fatal("variable not declared")};
  if($3.map["type"]!=$1.map["type"]) {log.Fatal("Type Mismatch")};
  q.next.code="ifgoto, jl, $1.map["value"], $3.map["value"], $$.map["true"]";r=new(node);q.next.next=r;r.code="=, $$.map["value"], 0";r.next=new(node);r.next.code="jmp, $$.map["after"]";r.next.next=new(node);s=r.next.next;s.code="label, $$.map["true"]";s.next=new(node);s.next.code="=, $$.map["value"], 1";s.next.next=new(node);s.next.next.code="label, $$.map["after"]"; }
...
| round_exp OP_ANDAND round_exp  {
  $$.map= make_entry("temp"+strconv.Itoa(temp_num));temp_num+=1;$$.map["type"]=$1.map["type"]; $$.map["false"]="label"+strconv.Itoa(label_num);$$.map["after"]="label"+strconv.Itoa(label_num);
    $$.code=new (node);p=copy_nodes($1.code,$$.code); p.next=new(node);q=copy_nodes(p.next,$3.code);q.next=new(node);if($1.map==NULL)||($3.map==NULL) {log.Fatal("variable not declared")};
  if($3.map["type"]!=$1.map["type"]) {log.Fatal("Type Mismatch")};
  q.next.code="ifgoto, je, $1.map["value"], 0, $$.map["false"]";r=new(node);q.next.next=r;r.code="ifgoto, je, $3.map["value"], 0, $$.map["false"]";r.next=new(node);rr=r.next; rr.code="=, $$.map["value"], 1";rr.next=new(node);rr.next.code="jmp, $$.map["after"]";rr.next.next=new(node);s=rr.next.next;s.code="label, $$.map["false"]";s.next=new(node);s.next.code="=, $$.map["value"], 0";s.next.next=new(node);s.next.next.code="label, $$.map["after"]"; }
...
| round_exp OP_OROR round_exp  {
  ...
  q.next.code="ifgoto, je, $1.map["value"], 1, $$.map["true"]";r=new(node);q.next.next=r;r.code="ifgoto, je, $3.map["value"], 1, $$.map["true"]";r.next=new(node);rr=r.next; rr.code="=, $$.map["value"], 0";rr.next=new(node);rr.next.code="jmp, $$.map["after"]";rr.next.next=new(node);s=rr.next.next;s.code="label, $$.map["true"]";s.next=new(node);s.next.code="=, $$.map["value"], 1";s.next.next=new(node);s.next.next.code="label, $$.map["after"]"; }
